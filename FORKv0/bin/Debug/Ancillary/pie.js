    ...
    h.AmPieChart = h.Class({
        ...
        checkOverlapping: function (d, f, c, b, h) {
            var e, k, a = this.chartData,
                ...
                n = f.label;
            if (n) {
                if (!0 === b) for (k = d + 1; k < v; k++) a[k].labelQuarter == c && (e = this.checkOverlappingReal(f, a[k], c)) && (k = v);
                else for (k = d - 1; 0 <= k; k--) a[k].labelQuarter == c && (e = this.checkOverlappingReal(f, a[k], c)) && (k = 0);
