...
namespace HTMLDev
{
    public static class NetworkHTML
    {
        ...
        public static void writeGraphHTML(ONETReport forkReport, int numberOfOccupations, Constants.AttributeType type, string FileName, string FileType = ".html")
        {
            ...
            {
                if (edge.getDistanceByAttribute(type) > maxDist) { maxDist = edge.getDistanceByAttribute(type); }
            }
        ...
        public static void writePathGraphHTML(string FileName, string FileType = ".html")
        {
            ...
            using (StreamWriter writer = new StreamWriter(fcreate))
            {
                writer.WriteLine("<!DOCTYPE html>");
                {
                    writer.WriteLine(quote + "name" + quote + ": " + quote + "Machine Operator" + quote + ",");
                    writer.WriteLine(quote + "label" + quote + ": " + quote + "[$35k - $77k]" + quote + ",");
                    writer.WriteLine(quote + "parent" + quote + ": " + quote + "null" + quote + ",");
                    writer.WriteLine(quote + "children" + quote + ": [");
                    writer.WriteLine("{");
                    writer.WriteLine(quote + "name" + quote + ": " + quote + "Production Machine Line Operator" + quote + ",");
                    writer.WriteLine(quote + "label" + quote + ": " + quote + "[$35k - $77k]" + quote + ",");
                    writer.WriteLine(quote + "parent" + quote + ": " + quote + "Machine Operator" + quote + ",");
                    writer.WriteLine(quote + "children" + quote + ": [");
                    writer.WriteLine("{");
                    writer.WriteLine(quote + "name" + quote + ": " + quote + "Factory Technician" + quote + ",");
                    writer.WriteLine(quote + "label" + quote + ": " + quote + "[$35k - $77k]" + quote + ",");
                    writer.WriteLine(quote + "parent" + quote + ": " + quote + "Production Machine Line Operator" + quote + "");
                    writer.WriteLine("},");
                    writer.WriteLine("{");
                    writer.WriteLine(quote + "name" + quote + ": " + quote + "Instrumentation Specialist" + quote + ",");
                    writer.WriteLine(quote + "label" + quote + ": " + quote + "[$35k - $77k]" + quote + ",");
                    writer.WriteLine(quote + "parent" + quote + ": " + quote + "Production Machine Line Operator" + quote + "");
                    writer.WriteLine("}");
                    writer.WriteLine("]");
                    writer.WriteLine("},");
                    writer.WriteLine("{");
                    writer.WriteLine(quote + "name" + quote + ": " + quote + "Production Team Leader" + quote + ",");
                    writer.WriteLine(quote + "label" + quote + ": " + quote + "[$35k - $77k]" + quote + ",");
                    writer.WriteLine(quote + "parent" + quote + ": " + quote + "Machine Operator" + quote + ",");
                    writer.WriteLine(quote + "children" + quote + ": [");
                    writer.WriteLine("{");
                    writer.WriteLine(quote + "name" + quote + ": " + quote + "Manufacturing Department Leader" + quote + ",");
                    writer.WriteLine(quote + "label" + quote + ": " + quote + "[$35k - $77k]" + quote + ",");
                    writer.WriteLine(quote + "parent" + quote + ": " + quote + "Production Team Leader" + quote + ",");
                    writer.WriteLine(quote + "children" + quote + ": [");
                    writer.WriteLine("{");
                    writer.WriteLine(quote + "name" + quote + ": " + quote + "Shift Leader" + quote + ",");
                    writer.WriteLine(quote + "label" + quote + ": " + quote + "[$35k - $77k]" + quote + ",");
                    writer.WriteLine(quote + "parent" + quote + ": " + quote + "Manufacturing Department Leader" + quote + "");
                    writer.WriteLine("},");
                    writer.WriteLine("{");
                    writer.WriteLine(quote + "name" + quote + ": " + quote + "Instrumentation Specialist" + quote + ",");
                    writer.WriteLine(quote + "label" + quote + ": " + quote + "[$35k - $77k]" + quote + ",");
                    ...
                    writer.WriteLine("},");
                    writer.WriteLine("{");
                    writer.WriteLine(quote + "name" + quote + ": " + quote + "Warehouse Operator" + quote + ",");
                    writer.WriteLine(quote + "label" + quote + ": " + quote + "[$35k - $77k]" + quote + ",");
                    writer.WriteLine(quote + "parent" + quote + ": " + quote + "Production Team Leader" + quote + "");
                    writer.WriteLine("}");
                    writer.WriteLine("]");
        ...
        public static double GetRandomNumber(double minimum, double maximum, int rounding = 1)
        {
            Random random = new Random();
            return Math.Round(random.NextDouble() * (maximum - minimum) + minimum, rounding);
        }
