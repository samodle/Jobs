...
(function () {
    ...
    e.Cuboid = e.Class({
        ...
        draw: function () {
            ...
            if (0 < Math.abs(h) || 0 < Math.abs(f)) if (isNaN(u)) E = w, w = e.adjustLuminosity(r, -.2), w = e.adjustLuminosity(r, -.2), z = e.polygon(b, [0, h, d + h, d, 0], [0, f, f, 0, 0],
            w, l, 1, p, 0, x), 0 < n && (M = e.line(b, [0, h, d + h], [0, f, f], p, n, k, v)), B = e.polygon(b, [0, 0, d, d, 0], [0, g, g, 0, 0], w, l, 1, p, 0, x), B.translate(h, f), 0 < n && (F = e.line(b, [h, h], [f, f + g], p, n, k, v)), G = e.polygon(b, [0, 0, h, h, 0], [0, g, g + f, f, 0], w, l, 1, p, 0, x), y = e.polygon(b, [d, d, d + h, d + h, d], [0, g, g + f, f, 0], w, l, 1, p, 0, x), 0 < n && (C = e.line(b, [d, d + h, d + h, d], [0, f, g + f, g], p, n, k, v)), w = e.adjustLuminosity(E, .2), E = e.polygon(b, [0, h, d + h, d, 0], [g, g + f, g + f, g, g], w, l, 1, p, 0, x), 0 < n && (L = e.line(b, [0, h, d + h], [g, g + f, g + f], p, n, k, v));
                ...
                I = D * u;
                J = H * u;.1 < D && .1 < D && (z = e.circle(b, D, r, l, k, p, n, !1, H), z.translate(w, N));.1 < I && .1 < I && (E = e.circle(b, I, e.adjustLuminosity(r, .5), l, k, p, n, !1, J), E.translate(O, P))
            }
            l = Q;
            1 > Math.abs(g) && (g = 0);
            1 > Math.abs(d) && (d = 0);
                ...
                if (this.parseDates && !this.equalSpacing) this.lastTime = a[a.length - 1].time, this.maxTime = e.resetDateToMin(new Date(this.lastTime + 1.05 * x), this.minPeriod, 1, b).getTime(), this.timeDifference = this.endTime - this.startTime, this.parseDatesDraw();
                    ...
                    f < m && (m = f), h += this.start, this.stepWidth = this.getStepWidth(f), 0 < m) {
                        ...
                        for (b = f; b <= this.end + 2; b++) {
                            ...
                            if (q && !isNaN(w)) if (b / w == Math.round(b / w) || p) b / m == Math.round(b / m) || p || (this.gridAlpha = this.minorGridAlpha, n = void 0);
                            else continue;
                            ...
                            t = new this.axisItemRenderer(this, f, n, p, B, t, void 0,
                            x, a, !1, v.labelColor, v.className);
                            t.serialDataItem = v;
                            this.pushAxisItem(t);
                            this.gridAlpha = r
                        }
                    ...
                    if (0 < this.gridCountR) for (b = f; b < a; b++) if (u = this.data[b].time, this.checkPeriodChange(g, A, u, n) && b >= F) {
                        ...
                        t = n = u
                    } else isNaN(w) || (this.checkPeriodChange(g, w, u, z) && (this.gridAlpha = this.minorGridAlpha, f = this.getCoordinate(b - this.start), q = new this.axisItemRenderer(this, f, void 0, void 0, void 0, void 0, void 0, void 0, void 0, !0), this.pushAxisItem(q),
                    z = u), this.gridAlpha = r)
                }
