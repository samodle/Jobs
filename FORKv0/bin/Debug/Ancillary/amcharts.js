...
(function () {
    ...
    d.wrappedText = function (a, b, c, e, h, f, g, k, l) {
        ...
        if (m) {
            ...
            if (q.width > k) {
                ...
                if (isNaN(r)) {
                    if (0 === l) for (p = 1; p < q; p++) r = Math.round(b.length / q * p), b = b.substr(0, r) + n + b.substr(r);
    ...
    d.deleteObject = function (a, b) {
        if (a) {
            ...
            if (0 !== b) if ("[object Array]" === Object.prototype.toString.call(a)) for (var c = 0; c < a.length; c++) d.deleteObject(a[c], b - 1), a[c] = null;
    ...
    d.parseDefs = function (a, b) {
        for (var c in a) {
            var e = typeof a[c];
            if (0 < a[c].length &&
                "object" == e) for (var h = 0; h < a[c].length; h++) e = document.createElementNS(d.SVG_NS, c), b.appendChild(e), d.parseDefs(a[c][h], e);
    ...
    d.AxisBase = d.Class({
        ...
        parseDatesDraw: function () {
            ...
            if (0 < this.gridCountR) for (a = k; a <= B; a++) {
                ...
                this.pushAxisItem(m);
                m = l = p;
                if (!isNaN(u)) for (h = 1; h < w; h += u) this.gridAlpha = this.minorGridAlpha, f = p + v * h, f = d.resetDateToMin(new Date(f), x, u, r).getTime(), f = new this.axisItemRenderer(this, (f - this.startTime) * this.stepWidth, void 0, void 0, void 0, void 0, void 0, void 0, void 0, !0), this.pushAxisItem(f);
                this.gridAlpha = z
            }
        },
    ...
    d.ValueAxis = d.Class({
        ...
        draw: function () {
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max) e = !0;
                ...
                else for (g = f; g < r; g += p) if (c = u * g + this.minCalc, h && this.max - this.min > 10 * this.min && (c -= this.min),
                c = d.roundTo(c, this.maxDecCount + 1), !this.integersOnly || Math.round(c) == c) if (isNaN(z) || Number(d.toFixed(c, z)) == c) {
        ...
        stackGraphs: function (a) {
            ...
            if (r && ("regular" == b || "100%" == b)) for (q = 0; q < k.length; q++) n = k[q], n.hidden || (m = n.type, n.chart == this.chart && n.valueAxis == this && a == m && n.stackable && (l && (n.stackGraph = l), l = n));
            for (l = this.start; l <= this.end; l++) {
                var t = 0;
                for (q = 0; q < k.length; q++) if (n = k[q], n.hidden) n.newStack && (h[l] = NaN, e[l] = NaN);
                else if (m = n.type, n.chart == this.chart && n.valueAxis == this && a == m && n.stackable) if (m = this.data[l].axes[this.id].graphs[n.id], g = m.values.value, isNaN(g)) n.newStack && (h[l] = NaN, e[l] = NaN);
                else {
            ...
            for (l = this.start; l <= this.end; l++) for (q = 0; q < k.length; q++)(n = k[q], n.hidden) ? n.newStack && (h[l] = NaN, e[l] = NaN) : (m = n.type, n.chart == this.chart && n.valueAxis == this && a == m && n.stackable && (m = this.data[l].axes[this.id].graphs[n.id],
            ...
            for (e = a; e <= b; e++) {
                ...
                for (d in h) if (h.hasOwnProperty(d)) {
                    ...
                    if (g.includeInMinMax && (!g.hidden || this.includeHidden)) {
                        ...
                        else for (var l in g) g.hasOwnProperty(l) && "percents" != l && "total" != l && (k = g[l], k < c && (c = k))
                    }
                }
            }
            return c
            ...
            for (b = this.start; b <= this.end; b++) {
                ...
                for (e in c) if (c.hasOwnProperty(e)) {
                    ...
                    if (d.includeInMinMax && (!d.hidden || this.includeHidden)) {
                        ...
                        else for (var g in d) d.hasOwnProperty(g) && "percents" != g && "total" != g && (f = d[g], f > a && (a = f))
                    }
                }
            }
            return a
...
(function () {
    ...
    d.RecItem = d.Class({
        construct: function (a, b, c, e, h, f, g, k, l, m, n, q) {
            ...
            Y && (Y.attr({
                "text-anchor": ia
            }), Y.translate(G, y), 0 !== n && Y.rotate(-n, a.chart.backgroundColor), a.allLabels.push(Y), this.label = Y, d.setCN(p, Y,
    ...
    d.AmGraph = d.Class({
        ...
        createSerialGraph: function () {
            ...
            if ("line" == g || "step" == g || "smoothedLine" == g) {
                if (0 < da) {
                    for (K = da - 1; - 1 < K; K--) if (G = e[K], y = G.axes[f.id].graphs[b], ka = y.values.value, !isNaN(ka)) {
                        da = K;
                        break
                    }
                    if (this.lineColorField) for (K = da; - 1 < K; K--) if (G = e[K], y = G.axes[f.id].graphs[b], y.lineColor) {
                        this.bulletColorSwitched = this.lineColorSwitched = y.lineColor;
                        break
                    }
                    if (this.fillColorsField) for (K = da; - 1 < K; K--) if (G = e[K], y = G.axes[f.id].graphs[b], y.fillColors) {
                        this.fillColorsSwitched = y.fillColors;
                        break
                    }
                    if (this.dashLengthField) for (K = da; - 1 < K; K--) if (G = e[K], y = G.axes[f.id].graphs[b], !isNaN(y.dashLength)) {
                        this.dashLengthSwitched = y.dashLength;
                        break
                    }
                }
                if (pa < e.length - 1) for (K = pa + 1; K < e.length; K++) if (G = e[K], y = G.axes[f.id].graphs[b],
            ...
            var R = [],
                S = [],
                Ka = !1;
            if ("line" == g || "step" == g || "smoothedLine" == g) if (this.stackable && "regular" == J || "100%" == J || this.fillToGraph) Ka = !0;
            ...
            for (K = da; K <= pa; K++) {
                ...
                if (Ca) {
                    ...
                    if ("candlestick" == g || "ohlc" == g) X = Ca.close, wb = Ca.low, Ea = f.getCoordinate(wb),
                    vb = Ca.high, Fa = f.getCoordinate(vb);
                    ma = Ca.open;
                    E = f.getCoordinate(X);
                    ...
                    switch (g) {
                        case "line":
                            ...
                            break;
                        case "smoothedLine":
                            if (isNaN(X)) z || (this.drawSmoothedGraph(v, w, R, S), v = [],
                            w = [], R = [], S = []);
                            else {
                                if (Math.abs(F - hb) >= jb || Math.abs(E - ib) >= jb) v.push(F), w.push(E), hb = F, ib = E;
                                ya = F;
                        ...
                        case "candlestick":
                            if (!isNaN(ma) && !isNaN(X)) {
                                ...
                                if (r) {
                                    ...
                                    xb && X >= ma && (Sa = 0);
                                    var oa = new d.Cuboid(h,
                                    M, fa, H, O, Ia, Sa, Z, ua, V, ia, u, r, ba, $a, kb, na),
                                        Bb, Cb;
                                ...
                                oa && (xa = oa.set, y.columnGraphics = xa, ca.push(xa), xa.translate(T, P - Z / 2), (y.url || this.showHandOnHover) && xa.setAttr("cursor", "pointer"), Ua && (ca.push(Ua), ca.push(ab)),
                                ya = F, za = E, r ? (ha = E, ga = F, "open" == l && (ga = N), "high" == l && (ga = Oa), "low" == l && (ga = Na)) : (ha = E, "open" == l && (ha = L), "high" == l && (ha = Fa), "low" == l && (ha = Ea), ga = F), U || (y.x = r ? P + M / 2 : T + M / 2, this.animateColumns(oa, K, F, N, E, L), this.addListeners(xa, y)))
                            }
                            break;
                        case "ohlc":
        ...
        drawLineGraph: function (a, b, c, e) {
            ...
            if (1 < a.length) {
                ...
                if (0 < f || 0 < w) if (q = a.join(";").split(";"), r = b.join(";").split(";"), n = g.type, "serial" == n ? 0 < c.length ? (c.reverse(), e.reverse(), q = a.concat(c), r = b.concat(e)) : h.rotate ? (r.push(r[r.length - 1]), q.push(x), r.push(r[0]), q.push(x), r.push(r[0]),
                ...
                d.setCN(g, b, h.bcn + "fill"), l.push(b)), v || void 0 !== u) isNaN(w) && (w = f), v || (v = u), k = d.polygon(k, q, r, v, w, 1, "#000", 0, a), d.setCN(g, k, h.bcn + "fill"), d.setCN(g, k, h.bcn + "fill-negative"), k.pattern(h.pattern, NaN, g.path), m.push(k), m.click(function (a) {
        ...
        drawSmoothedGraph: function (a, b, c, e) {
            if (1 < a.length) {
                ...
                0 < q && (m = a.join(";").split(";"), p = b.join(";").split(";"), n = "", 0 < c.length ? (c.push("M"), e.push("M"), c.reverse(), e.reverse(), m = a.concat(c), p = b.concat(e)) : (this.rotate ? (n += " L" + v + "," + b[b.length - 1], n += " L" + v + "," + b[0]) : (n += " L" + a[a.length - 1] + "," + v, n += " L" + a[0] + "," + v), n += " L" + a[0] + "," + b[0]), c = new d.Bezier(g, m, p, NaN,
                0, 0, r, q, h, n), d.setCN(f, c, this.bcn + "fill"), c.path.pattern(this.pattern, NaN, f.path), k.push(c.path), u || void 0 !== t) && (z || (z = q), u || (u = t), a = new d.Bezier(g, a, b, NaN, 0, 0, u, z, h, n), a.path.pattern(this.pattern, NaN, f.path), d.setCN(f, a, this.bcn + "fill"), d.setCN(f, a, this.bcn + "fill-negative"), l.push(a.path));
                this.applyMask(l, k)
            }
        },
...
(function () {
    ...
    d.ChartCursor = d.Class({
        ...
        updateCrosshair: function () {
            ...
            this.zooming && (a.hideXScrollbar && (b = NaN), a.hideYScrollbar && (c = NaN),
            this.updateSelectionSize(b, c));
            this.fireMoved();
        ...
        hideCursor: function (a) {
            void 0 === a && (a = !0);
            this.leaveCursor || (this.hideObj(this.set), this.hideObj(this.categoryBalloon), this.hideObj(this.line), this.hideObj(this.vLine), this.hideObj(this.hLine), this.hideObj(this.vaBalloon), this.hideObj(this.allBullets), this.destroyValueBalloons(),
        ...
        normalizeBulletSize: function () {
            ...
            if (a) for (var b = 0; b < a.length; b++) {
                var c = a[b],
                    e = c.bulletGraphics;
                e && (e.translate(c.bx, c.by, 1), c = c.graph, isNaN(this.graphBulletAlpha) || (e.setAttr("fill-opacity", c.bulletAlpha), e.setAttr("stroke-opacity",
                c.bulletBorderAlpha)))
            }
        },
                ...
                if (r) {
                    ...
                    if (c.mouseIsOver || B || D || this.forceShow) if (this.forceShow = !1, D) {
                        ...
                        0 !== h && (k = {
                            type: "zoomed",
                            target: this
                        }, k.chart = this.chart, g.parseDates && !g.equalSpacing ? (c + h > x && (h = x - c), B + h < w && (h = w - B), k.start = Math.round(B + h), k.end = Math.round(c + h), this.fire(k.type, k)) : I + h >= this.data.length || 0 > m + h || (k.start = m + h, k.end = I + h, this.fire(k.type, k)))
                    } else {
                        ...
                        if (this.oneBalloonOnly) {
                            t = Infinity;
                            for (g = 0; g < C.length; g++) v = C[g], v.showBalloon && !v.hidden && v.balloonText && (w = r.axes[v.valueAxis.id].graphs[v.id], x = w.y, isNaN(x) || (u ? Math.abs(h - x) < t && (t = Math.abs(h - x), I = v) : Math.abs(f - x) < t && (t = Math.abs(f - x), I = v)));
                        ...
                        if (a != this.previousIndex || I != this.previousMostCloseGraph) if (this.normalizeBulletSize(), this.destroyValueBalloons(), this.resizedBullets = [], C && this.valueBalloonsEnabled && z && c.balloon.enabled) {
                            ...
                            for (g = 0; g < C.length; g++) if (v = C[g], x = NaN, (!this.oneBalloonOnly || v == I) && v.showBalloon && !v.hidden && v.balloonText && ("step" == v.type && "left" == v.stepDirection && (r = this.data[a + 1]), r)) {
                                if (w = r.axes[v.valueAxis.id].graphs[v.id]) x = w.y;
                                if (this.showNextAvailable && isNaN(x) && a + 1 < this.data.length) for (z = a + 1; z < this.data.length; z++) if (e = this.data[z]) if (w = e.axes[v.valueAxis.id].graphs[v.id], x = w.y, !isNaN(x)) break;
                                if (!isNaN(x)) {
                                    e = w.x;
                                    l = !0;
                                    if (u) {
                                    ...
                                    l && (l = this.graphBulletSize, A = this.graphBulletAlpha, 1 == l && isNaN(A) || !d.isModern || !(D = w.bulletGraphics) || (D.translate(w.bx, w.by, l), this.resizedBullets.push(w), isNaN(A) || (D.setAttr("fill-opacity", A), D.setAttr("stroke-opacity", A))), l = v.valueBalloon, A = c.getBalloonColor(v, w),
                                    ...
                                    v = l.textDiv) && (v.style.visibility = "hidden"))
                                }
                            }
                ...
                if (this.enabled && 0 < b.length) {
                    if (this.pan) this.rolledOver = !1;
                        ...
                        if ("cursor" == this.type) this.rotate ? this.selectionPosY = h : this.selectionPosX = h = e, 4 > Math.abs(h - this.initialMouse) && this.fromIndex == this.index || (this.index < this.fromIndex ? (c.end = this.fromIndex, c.start = this.index) : (c.end = this.index, c.start = this.fromIndex), h = a.categoryAxis, h.parseDates && !h.equalSpacing && (b[c.start] && (c.start = b[c.start].time), b[c.end] && (c.end = a.getEndTime(b[c.end].time))), this.skipZoomDispatch || this.fire(c.type, c));
                            ...
                            3 > Math.abs(e - g) && 3 > Math.abs(h - k) || (b = Math.min(g, e), f = Math.min(k, h), e = Math.abs(g - e), h = Math.abs(k - h), a.hideXScrollbar && (b = 0, e = this.width), a.hideYScrollbar && (f = 0, h = this.height),
                            c.selectionHeight = h, c.selectionWidth = e, c.selectionY = f, c.selectionX = b, this.skipZoomDispatch || this.fire(c.type, c))
                        }
...
(function () {
    ...
    d.AmRectangularChart = d.Class({
        ...
        drawPlotArea: function () {
            ...
            g.translate(c + a, e + b);
            this.set.push(g);
            0 !== a && 0 !== b && (g = this.plotAreaFillColors, "object" == typeof g && (g = g[0]), g = d.adjustLuminosity(g, -.15), h = d.polygon(this.container, [0, a, h + a, h, 0], [0, b, b, 0, 0], g, k, 1, l, m), d.setCN(this, h, "plot-area-bottom"), h.translate(c, e + f), this.set.push(h), a = d.polygon(this.container, [0, 0, a, a, 0], [0, f, f + b, b, 0], g, k, 1, l, m), d.setCN(this, a, "plot-area-left"),
            a.translate(c, e), this.set.push(a));
        ...
        updateChartCursor: function () {
            var a = this.chartCursor;
            a && (a = d.processObject(a, d.ChartCursor,
            this.theme), this.addChartCursor(a), a.x = this.marginLeftReal, a.y = this.marginTopReal, a.width = this.plotAreaWidth - 1, a.height = this.plotAreaHeight - 1, a.chart = this)
        },
...
(function () {
    ...
    d.handDrawnLine = function (a, b, c, e, h, f, g, k, l, m) {
        var n, q = a.set();
        for (n = 1; n < b.length; n++) for (var p = [b[n - 1], b[n]], r = [c[n - 1], c[n]], r = d.makeHD(p, r, a.handDrawScatter), p = r[0], r = r[1], t = 1; t < p.length; t++) q.push(d.line(a, [p[t - 1], p[t]], [r[t - 1], r[t]], e, h, f + Math.random() * a.handDrawThickness - a.handDrawThickness / 2, g, k, l, m, !0));
        return q
    };
    ...
    d.wedge = function (a, b, c, e, h, f, g, k, l, m, n, q, p) {
        ...
        e = a.set();
        var O;
        u && (z = r(10 * z), x = r(10 * x), B = r(10 * B), C = r(10 * C), w = r(10 * w), A = r(10 * A), D = r(10 * D), v = r(10 * v), b = r(10 * b), l = r(10 * l), c = r(10 * c), f *= 10, g *= 10, k *= 10, t *= 10, 1 > Math.abs(h) && 1 >= Math.abs(B - x) && 1 >= Math.abs(D - A) && (O = !0));
        h = "";
        var J;
        q && (I["fill-opacity"] = 0, I["stroke-opacity"] = m["stroke-opacity"] / 2, I.stroke = m.stroke);
        0 < l && (J = " M" + z + "," + (w + l) + " L" + x + "," + (A + l), u ? (O || (J += " A" + (b - f) + "," + (l + c - g) + "," + (b + f) + "," + (l + c + g) + "," + x + "," + (A + l) + "," + B + "," + (D + l)), J += " L" + C + "," + (v + l), 0 < k && (O || (J += " B" + (b - k) + "," + (l + c - t) + "," + (b + k) + "," + (l + c + t) + "," + C + "," + (l + v) + "," + z + "," + (l + w)))) : (J += " A" + f + "," + g + ",0," + H + ",1," + B + "," + (D + l) + " L" + C + "," + (v + l), 0 < k && (J += " A" + k + "," + t + ",0," + H + ",0," + z + "," + (w + l))), J = a.path(J + " Z", void 0,
        void 0, "1000,1000").attr(I), e.push(J), J = a.path(" M" + z + "," + w + " L" + z + "," + (w + l) + " L" + x + "," + (A + l) + " L" + x + "," + A + " L" + z + "," + w + " Z", void 0, void 0, "1000,1000").attr(I), l = a.path(" M" + B + "," + D + " L" + B + "," + (D + l) + " L" + C + "," + (v + l) + " L" + C + "," + v + " L" + B + "," + D + " Z", void 0, void 0, "1000,1000").attr(I), e.push(J), e.push(l));
        u ? (O || (h = " A" + r(b - f) + "," + r(c - g) + "," + r(b + f) + "," + r(c + g) + "," + r(x) + "," + r(A) + "," + r(B) + "," + r(D)), f = " M" + r(z) + "," + r(w) + " L" + r(x) + "," + r(A) + h + " L" + r(C) + "," + r(v)) : f = " M" + z + "," + w + " L" + x + "," + A + (" A" + f + "," + g + ",0," + H + ",1," + B + "," + D) + " L" + C + "," + v;
    ...
    d.AmDraw = d.Class({
        ...
        addDefs: function (a) {
            if (d.hasSVG) {
                ...
                a.addCodeCredits && b.appendChild(document.createTextNode(" " + a.version));
                c.appendChild(b);
    ...
    d.AmLegend = d.Class({
        ...
        arrangeEntries: function () {
            ...
            for (x = 0; x < v.length; x++) {
                ...
                H + w.width > q && 0 < x && 0 !== A && (r++, A = 0,
                H = f, B = H + w.width + f + n, D = D + C + m, C = 0);
                I.translate(H, D);
                A++;
        ...
        createValue: function (a) {
            ...
            if (!1 !== a.visibleInLegend) {
                ...
                if (b.valueText && 0 < b.valueWidth) {
                    ...
                    g = d.text(b.container,
                    k, g, b.chart.fontFamily, c, l);
            ...
            for (c = 0; c < a.length; c++) {
                ...
                if (d) f.value ? h.text(f.value) : h.text("");
                    ...
                    if (void 0 !== f.type) {
                        ...
                        k ? (g = this.valueText, f.legendValueText && (g = f.legendValueText), g = b.formatString(g, k)) : l && (g = b.formatPeriodString(l,
                        f))
